...
description: "В этом видео-уроке, мы познакомимся с Composer библиотекой и подключим эту библиотеку к нашему проекту. Также, мы начнем изучать и разберемся что такое Slim. Эта библиотека позволит нам добавить человекопонятные ссылки для блога."
---
