---
title: "Пишем Блог на PHP. Часть 8: Страница Постов и пагинация"
...
Обновленный метод `PostMapper::getList()` получает новую сигнатуру метода. Дополнительные аргументы дают нам возможность делать выборку постов с заданым шагом и размером.
...
Новый шаблон `section/blog.twig`, который будет отрисовывать список постов. Массив постов мы будем передавать с обработчика, который мы добавили в `index.php` файле.
...
Давайте добавим новую ссылку на страницу Blog в нафигацию сайта. Обновленный шаблон `section/navigation.twig`.
...
Шаблон `section/pagination.twig`, который отвечает за отрисовку пагинации на странице Блог.
